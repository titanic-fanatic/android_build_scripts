...
function banner(){
    ...
    echo -e "${lcyan}***************************************************${NC}"
    echo "                                                   "
    echo -e "              ${lcyan}SlimKat4.4 BUILD SCRIPT${NC}              "
...
echo -e "${lcyan}Build errors being recorded to: ${NC}logs/Slim4.4BuildError-$DATE_NOW.log"
echo " "
echo " "
...
make bacon -j$THREADS 2> logs/Slim4.4BuildErrors-$DATE_NOW.log
